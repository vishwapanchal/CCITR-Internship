  ...
  return (
    <main className="flex-1 flex flex-col min-h-[calc(100vh-80px)] bg-[#f4f7f9] relative overflow-hidden p-4 md:p-8">
      ...
      >
        ...
        <m.div variants={bentoVariants} className="col-span-1 md:col-span-2 lg:col-span-2 md:row-span-2 bg-white/60 backdrop-blur-xl border border-white/80 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-[2rem] p-8 md:p-12 flex flex-col justify-center relative overflow-hidden group">
        ...
        <m.div variants={bentoVariants} className="col-span-1 lg:col-span-1 bg-white/60 backdrop-blur-xl border border-white/80 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-[2rem] p-6 flex flex-col items-center justify-center text-center group hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all">
        ...
        <m.div variants={bentoVariants} className="col-span-1 md:col-span-2 lg:col-span-1 bg-white/60 backdrop-blur-xl border border-white/80 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-[2rem] p-6 flex flex-col items-center justify-center text-center group hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all">
        ...
        <m.div variants={bentoVariants} className="col-span-1 md:col-span-1 lg:col-span-1 bg-slate-800 rounded-[2rem] p-6 flex flex-col justify-between text-white shadow-xl relative overflow-hidden group hover:shadow-2xl transition-all">
